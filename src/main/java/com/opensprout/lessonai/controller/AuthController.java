...
public class AuthController {
    ...
    @PutMapping("/me")
    public ApiResponse<UserProfileRespVO> updateProfile(@Valid @RequestBody UserProfileUpdateReqVO reqVO) {
        return ApiResponse.success(userService.updateProfile(reqVO));
    }

    @PutMapping("/password")
    public ApiResponse<Void> updatePassword(@Valid @RequestBody UserPasswordUpdateReqVO reqVO) {
        userService.updatePassword(reqVO);
